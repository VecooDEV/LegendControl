...
public class TaskUtils {
    ...
    public static class Builder {
        ...
        public Builder delay(long delay) {
            if (delay < 0) {
                LegendControl.getLogger().error("[LegendControl] Delay must not be below 0");
                return null;
            }
            this.delay = delay;
            return this;
        ...
        public Builder interval(long interval) {
            if (interval < 0) {
                LegendControl.getLogger().error("[LegendControl] Interval must not be below 0");
                return null;
            }
            this.interval = interval;
            return this;
        ...
        public Builder iterations(long iterations) {
            if (iterations < -1) {
                LegendControl.getLogger().error("[LegendControl] Iterations must not be below -1");
                return null;
            }
            this.iterations = iterations;
            return this;
        ...
        public TaskUtils build() {
            if (consumer == null) {
                LegendControl.getLogger().error("[LegendControl] Consumer must be set");
                return null;
            }
