...
public class LegendControlFactory {
    public static class ServerProvider {
        ...
        public static void setChanceLegend(String source, float amount) {
            LegendControl.getInstance().getServerProvider().getServerStorage().setChanceLegend(source, amount);
        }

        public static void addChanceLegend(String source, float amount) {
            LegendControl.getInstance().getServerProvider().getServerStorage().addChanceLegend(source, amount);
        }

        public static void removeChanceLegend(String source, float amount) {
            LegendControl.getInstance().getServerProvider().getServerStorage().removeChanceLegend(source, amount);
        }
